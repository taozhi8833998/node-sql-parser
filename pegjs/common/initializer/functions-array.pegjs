// Common initializer functions with array-aware createList (without location tracking)
// Note: This file content is meant to be imported inside { } initializer block
  ...
  // Create a binary expression node (without location tracking)
  ...
  // Create a list from head and tail pattern (array-aware version)
