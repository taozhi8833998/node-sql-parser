{
  ...
  // Import common initializer functions (array-aware createList variant) and variables
  @import 'common/initializer/functions-array.pegjs'
...
cast_expr
  ...
  / e:(column_ref_quoted / literal / interval_expr / aggr_func / window_func / func_call / case_expr / column_ref_array_index / param) __ c:cast_double_colon? {
    /* => {
        type: 'cast';
...
// Redshift specific: literal_array
literal_array
...
// Redshift specific: LOGIC_OPERATOR without XOR
LOGIC_OPERATOR = OPERATOR_CONCATENATION / OPERATOR_AND

// Redshift specific symbols
WELL_ARROW = '#>'
DOUBLE_WELL_ARROW = '#>>'

// Identifier patterns (Redshift with unicode support)
...
// Redshift specific: custom comment handling with nested block comments
__
  = (whitespace / comment)*
...
// Redshift specific: interval_unit
interval_unit
  = KW_UNIT_YEAR
  / KW_UNIT_MONTH
  / KW_UNIT_DAY
...
// assign_stmt_list and assign_stmt are imported from common/procedure/assign-to.pegjs
@import 'common/procedure/assign-to.pegjs'
