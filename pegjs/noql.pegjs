...
cast_expr
  ...
  / e:(literal / interval_expr / aggr_func / window_func / func_call / case_expr /column_ref_array_index / param) __ c:cast_double_colon? {
    /* => {
        type: 'cast';
...
// NoQL specific: LOGIC_OPERATOR without XOR
LOGIC_OPERATOR = OPERATOR_CONCATENATION / OPERATOR_AND

// NoQL specific: additional arrow operators
WELL_ARROW = '#>'
DOUBLE_WELL_ARROW = '#>>'

// NoQL specific: ident_start, ident_part, column_part, line_terminator rules
ident_start = [A-Za-z_\u4e00-\u9fa5\u00C0-\u017F]
ident_part  = [A-Za-z0-9_\-$\u4e00-\u9fa5\u00C0-\u017F]
column_part  = [A-Za-z0-9_\u4e00-\u9fa5\u00C0-\u017F]
line_terminator = [\n\r]

// NoQL specific: comment rules (has nested block comment)
__
  = (whitespace / comment)*
