...
const moduleCfg = {
    rules: [
        ...
        // pegjs-loader removed - parsers are now pre-generated by gulp (build:pegjs)
    ],
}
...
if (isProd) {
    ...
    for (const target of ['web', 'node']) {
        config.push(
            ...
            // Add one light bundle per dialect (using pre-generated parsers from lib/parser/)
            ...require('./gulp/config.json').dialects
                .map(parser =>
